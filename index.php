...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'Save')
{
    //print_r($_REQUEST);
     ...
     $UpdateQuery = "UPDATE setings SET 
    ltr_to_kg='".$_REQUEST['ltr_to_kg']."'
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ltr to KG</h6>
                        </div>
                        <div class="card-body">
                              <form
            action=""
  ...
  <div class="card card-body">
    ...
    <div class="form-group">
      <label for="input1">Ltr To KG</label>
     <input type="text" required class="form-control" id="ltr_to_kg" value="<?php print_r($row['ltr_to_kg']); ?>" name="ltr_to_kg">
    </div>
